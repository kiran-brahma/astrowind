...
<div className="stats stats-vertical lg:stats-horizontal shadow">
  ...
  <div className="stat">
    <div className="stat-title">Total Security Personnel Deployed</div>
    <div className="stat-value">7500+</div>
  </div>
  
  <div className="stat">
    <div className="stat-title">States with PSARA License</div>
    <div className="stat-value">18+ Counting</div>
  </div>
  <div className="stat">
